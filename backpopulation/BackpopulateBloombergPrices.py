...
back_data = pd.read_csv("DataOutput.csv", index_col=[0])
print(back_data)
...
back_data = back_data.rename(columns={'date': 'trade_date',
                                      ...
                                      'PX_LOW': 'low_price',
                                      'PX_VOLUME': 'volume',
                                      'EQY_WEIGHTED_AVG_PX': 'vwap_price',
                                      'INDIA_TOTAL_DELIVERY_PCT': 'delivered_to_traded'})

back_data.trade_date = back_data.trade_date.apply(parse_date)
back_data['close_price'] = back_data['last_price']
back_data['delivered_to_traded'] = back_data['delivered_to_traded'] / 100
back_data['last_price'] = back_data['close_price']
