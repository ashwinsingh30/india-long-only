...
def backtest_performance_with_tc(signal_function, *args):
    ...
    old_signal['ls_weight'] = np.nan
    old_signal['sn_weight'] = np.nan
    old_signal['lmb_weight'] = np.nan
    ...
    while current <= end_date:
        ...
        optimised_signal = signal_function(current_date, old_signal[['ls_weight', 'sn_weight', 'lmb_weight']],
                                           *args)[['Weight', 'ls_weight', 'sn_weight', 'lmb_weight']]
...
strategy_name = '_nse500'
strategy = india_long_short_pulse
