...
class PrimarySignals(Base):
    ...
    eps_revisions_one_qtr = Column(Float, nullable=True)
    eps_revisions_two_qtr = Column(Float, nullable=True)
    eps_revisions_one_year = Column(Float, nullable=True)
    eps_revision_dispersion_one_qtr = Column(Float, nullable=True)
    eps_revision_dispersion_two_qtr = Column(Float, nullable=True)
    eps_revision_dispersion_one_year = Column(Float, nullable=True)
    ...
    one_month_abs_momentum = Column(Float, nullable=True)
    one_month_momentum_vol_adjusted = Column(Float, nullable=True)
    one_month_residual_momentum = Column(Float, nullable=True)
    one_month_residual_momentum_vol_adjusted = Column(Float, nullable=True)
    abs_price_momentum_one_year = Column(Float, nullable=True)
    residual_price_momentum_one_year = Column(Float, nullable=True)
    abs_price_momentum_one_qtr = Column(Float, nullable=True)
    residual_price_momentum_one_qtr = Column(Float, nullable=True)
